...
class Ball(pygame.sprite.Sprite):
    ...
    def bounce(self, line):
        ...
        print "----------------------"
        print "degrees    : " , deg*180/math.pi
        print "line slope : " , line_slope
        #print "  lineX = " ,line_vec[0]
        #print "  lineY = " ,line_vec[1]
        
        #print "side : " , side
        if(side == 1 and line_slope<0):
            ball_vec = rotateVec(ball_vec,(2*math.pi - 2*deg))
            print "1"
        if(side == 0 and line_slope<0):
    ...
    def bounce_old(self,line):#POSITIVES AND NEGATIVES ARE SWITCHED B/C OF Y AXIS
...
def CrossProductDegrees(line_v, ball_v):
